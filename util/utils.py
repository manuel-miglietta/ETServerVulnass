...
def parser_response(content):
    ...
    for vuln in data['result']['CVE_Items']:
        ...
        print("\tDescription:"+vuln['cve']['description']['description_data'][0]['value'])
        try:
            print("\tCVSS V2 Risk: "+risk_type(vuln['impact']['baseMetricV2']['severity']))
        except: 
            print("\t")
        
        try:
            print("\tCVSS V3 Risk: "+risk_type(vuln['impact']['baseMetricV3']['cvssV3']['baseSeverity']))
        except:
            print("\t")
